...
def get_live_bus_location(bus_line_id="72"):
    ...
    try:
        print(f"   📡 Calling BODS API for Bus {bus_line_id}...")
        ...
        if response.status_code == 200:
            ...
            print(f"   ✅ Found {len(activities)} buses in feed")
            ...
            for activity in activities:
                ...
                if line_ref is not None and line_ref.text == bus_line_id:
                    ...
                    if latitude is not None and longitude is not None:
                        ...
                        print(f"   ✅ REAL BUS LOCATION: Bus {bus_line_id} at ({lat:.4f}, {lon:.4f})")
                        return (lat, lon, "En Route (BODS Real)")
